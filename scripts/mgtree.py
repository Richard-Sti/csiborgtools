...
#======================
    ...
    #==========================
        ...
        # self.workdir = getcwd()
        self.workdir = "/mnt/extraspace/hdesmond/ramses_out_7444"
        ...
        if (self.start > 0):
            ...
            if self.workdir + "/" + 'output_'+startnrstr not in outputlist:
        ...
        infofile = self.workdir + "/" + self.lastdir+'/'+'info_'+self.lastdir[-5:]+'.txt'
        f = open(infofile, 'r')
        ncpuline = f.readline()
        line = ncpuline.split()
    ...
    for output in range(noutput):
        ...
        if output < noutput-1: # don't try to read progenitor stuff from output_00001
            ...
            try:
                ...
                workdir = "/mnt/extraspace/hdesmond/ramses_out_7444"
                fnames = ["".join([workdir, '/', srcdir,'/mergertree_',srcdir[-5:],'.dat'])]
                ncpu = 1
        ...
        try:
            ...
            #-------------------------------------
            fileloc = "/mnt/extraspace/hdesmond/ramses_out_7444/" + srcdir+'/info_'+dirnr+'.txt'
            print(fileloc)
