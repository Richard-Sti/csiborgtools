...
###############################################################################
#                         CSiBORG snapshot class                            #
###############################################################################


class CSiBORGSnapshot(BaseSnapshot):
    """
    CSiBORG snapshot from Gadget4 resimulations.
...
class QuijoteSnapshot(CSiBORGSnapshot):
    """
